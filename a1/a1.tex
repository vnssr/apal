...
\textbf{Note:} Implementations and resources are uploaded to this \href{https://github.com/vnssr/apal}{github}

\question{1}{\textit{Resizable Arrays}}
\part{a} Append Latency (compared to built-in Vector) \\
